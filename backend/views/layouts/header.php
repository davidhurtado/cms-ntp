...
<header class="main-header">
    ...
    <a href="<?= Yii::$app->homeUrl ?>" class="logo">
        ...
        <span class="logo-lg"><b>NTP</b> PUCESE</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?= $baseUrl ?>/dist/img/avatar.png" class="user-image" alt="User Image">
...
<!--                        <li class="user-body">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?= Yii::$app->homeUrl ?>?r=/user/settings/profile" class="btn btn-default btn-flat">Perfil</a>
                            </div>
                            <div class="pull-right">
                               <?= Html::a('Salir', Url::toRoute(['/user/security/logout']), ['data-method' => 'post','class'=>'btn btn-default btn-flat']) ?> 
                            </div>
                        </li>
                    </ul>
                </li>
